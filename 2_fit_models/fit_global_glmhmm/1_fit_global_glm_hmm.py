...
from glm_hmm_utils import load_cluster_arr, load_session_fold_lookup, \
    ...
    update_features
from glm_hmm_utils import load_glm_vectors, load_global_params, fit_glm_hmm, load_tags # my addition
...
K_vals = [2, 3, 4] #[2, 3, 4, 5] # number of states 
num_folds = 5
...
if __name__ == '__main__':
    ...
    if z == 0: # for z in range(len(cluster_arr)):
